      ...
      <div className="container mx-auto p-6 space-y-6">
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-2xl font-bold text-foreground">Create New Catalog</h1>
              <p className="text-muted-foreground">Create a personalized product catalog for a customer</p>
            </div>
          </div>
        </div>
          ...
          <div className="lg:col-span-2 space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Enter the basic details for the new catalog
                </CardDescription>
              </CardHeader>
              <CardContent>
                <Form {...form}>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Products that will be included in this catalog
                </CardDescription>
              </CardHeader>
              <CardContent>
